...
namespace PWMIS.Core.Extensions
{
    ...
    public abstract class DbContext
    {
        ...
        private static bool checkedDb; //数据库文件是否已经创建
        ...
        {
            return ExecuteQuery(data, (q, e) => q.Insert(e));
        }
        ...
        {
            return ExecuteQuery(data, (q, e) => q.Update(e));
        }
        ...
        {
            return ExecuteQuery(data, (q, e) => q.Delete(e));
        }
