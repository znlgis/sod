...
namespace PWMIS.DataMap.SqlMap
{
    ...
    public class SqlMapper
    {
        ...
        private readonly List<string> arrStrParas = new List<string>();
        private readonly List<string> arrStrReplaceText = new List<string>();
        //替换参数数组
        ...
        public IDataParameter[] GetParameters(string SqlMapScript)
        {
            ...
            for (var I = 0; I <= arrStrParas.Count - 1; I++)
            {
                var strArrTemp = arrStrParas[I].Split(':');
                ...
                if (result != null)
                {
                    ...
                    if (reader.Read())
                    {
                        ...
                        do
                        {
                            ...
                            var item = (EntityBase) result.Clone();
