...
namespace PWMIS.DataForms.Adapter
{
    ...
    public class MyWinForm : MyDataForm
    {
        ...
        ///     窗体控件数据映射类
        /// </summary>
        public static WinFormControlDataMap DataMap => new WinFormControlDataMap();
        ...
        public static void ClearIBData(Control.ControlCollection Controls)
        {
            //使用匿名委托
        ...
        private static void findIBControls(List<IDataControl> arrIBs, ICollection controls)
        {
            foreach (Control ctr in controls)
                ...
                else if (ctr.HasChildren) findIBControls(arrIBs, ctr.Controls);
        }
        ...
        public static List<IBCommand> GetSelectAndDeleteCommand(Control.ControlCollection Controls)
        {
            var IBControls = new List<IDataControl>();
            findIBControls(IBControls, Controls);
        ...
        /// <returns></returns>
        public static List<ICommandControl> FindCommandControls(Control.ControlCollection Controls)
        {
            var list = new List<ICommandControl>();
        ...
        public void AutoSelectIBForm(Control.ControlCollection Controls)
        {
            var IBControls = new List<IDataControl>();
            findIBControls(IBControls, Controls);
        ...
        public void AutoSelectIBForm(Control.ControlCollection Controls, DataSet dsSource)
        {
            var IBControls = new List<IDataControl>();
            findIBControls(IBControls, Controls);
        ...
        public void AutoSelectIBForm(Control.ControlCollection Controls, IEntity entity)
        {
            var IBControls = new List<IDataControl>();
            findIBControls(IBControls, Controls);
        ...
        public int AutoDeleteIBForm(Control.ControlCollection Controls)
        {
            var IBControls = new List<IDataControl>();
            findIBControls(IBControls, Controls);
