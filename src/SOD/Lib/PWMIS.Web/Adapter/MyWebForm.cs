...
namespace PWMIS.DataForms.Adapter
{
    ...
    public class MyWebForm : MyDataForm
    {
        ...
        private static MyWebForm _instance;
        ...
        ///     Web 窗体控件数据映射类
        /// </summary>
        public static WebControlDataMap DataMap => new WebControlDataMap();
        ...
        private static void findIBControls(List<IDataControl> arrIBs, ControlCollection controls)
        {
            foreach (Control ctr in controls)
                ...
                else if (ctr.HasControls()) findIBControls(arrIBs, ctr.Controls);
        }
