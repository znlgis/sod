...
namespace SODTest
{
    ...
    public class UserEntity : EntityBase, ITbUser
    {
        ...
        {
            get => getProperty<string>("LoginName");
        ...
        {
            get => getProperty<DateTime>("BirthDate");
    ...
    public class UserEntity2 : EntityBase
    {
        ...
        public int UserID
        {
            get => getProperty<int>("ID", 0); //带属性字段名索引，加快属性访问
            set => setProperty("ID", 0, value);
        }

        public string Name
        {
            get => getProperty<string>("Name", 1);
            set => setProperty("Name", 1, value, 100);
        }

        public string LoginName
        {
            get => getProperty<string>("LoginName", 2);
            set => setProperty("LoginName", 2, value, 50);
        }

        public string PWD
        {
            get => getProperty<string>("Password", 3);
            set => setProperty("Password", 3, value, 50);
        }

        public bool Sex
        {
            get => getProperty<bool>("Sex", 4);
            set => setProperty("Sex", 4, value);
        }

        public DateTime BirthDate
        {
            get => getProperty<DateTime>("BirthDate", 5);
        ...
        {
            PropertyNames = new[] { "ID", "Name", "LoginName", "Password", "Sex", "BirthDate" };
        }
    }
}