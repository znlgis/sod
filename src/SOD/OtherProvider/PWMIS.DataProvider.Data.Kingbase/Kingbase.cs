...
using Kdbndp;
using PWMIS.Common;
using PWMIS.KingbaseClient.Properties;
...
namespace PWMIS.DataProvider.Data
{
    ...
    public class Kingbase : AdoHelper
    {
        ...
        ///     获取当前数据库类型的枚举
        /// </summary>
        public override DBMSType CurrentDBMSType => DBMSType.Kingbase;
        ...
        protected override IDbConnection GetConnection()
        {
            ...
            if (conn == null) conn = new KdbndpConnection(ConnectionString);
            //conn.Open ();
            return conn;
        }
        ...
        {
            var conn = (KdbndpConnection)GetConnection();
