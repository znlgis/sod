...
namespace PWMIS.DataProvider.Data
{
    ...
    public class MySQL : AdoHelper
    {
        ...
        ///     获取当前数据库类型的枚举
        /// </summary>
        public override DBMSType CurrentDBMSType => DBMSType.MySql;
        ...
        ///     连接所使用的用户ID
        /// </summary>
        public override string ConnectionUserID => ((MySqlConnectionStringBuilder)ConnectionStringBuilder).UserID;
        ...
        {
            var mysqlPara = para as MySqlParameter;
            var dbType = mysqlPara.MySqlDbType;
