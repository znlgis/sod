...
#Region " Class GetTabRegionEventArgs "
    ...
    Public Class GetTabRegionEventArgs
        ...
        Private ReadOnly m_TabWidth As Integer
        Private ReadOnly m_TabHeight As Integer
        Private ReadOnly m_Selected As Boolean

        Private Sub New()
        End Sub

        <Description("Initializes a new instance of the MdiTabControl.TabControl.GetTabRegionEventArgs class.")>
        Public Sub New(Points() As Point, Width As Integer, Height As Integer, Selected As Boolean)
            MyBase.new()
            m_Points = Points
            m_TabWidth = Width
            m_TabHeight = Height
...
#Region " Class TabPaintEventArgs "
    ...
    Public Class TabPaintEventArgs
        ...
        Private ReadOnly m_Selected As Boolean = False
        Private ReadOnly m_Hot As Boolean = False
        Private ReadOnly m_GraphicPath As GraphicsPath
        Private ReadOnly m_TabWidth As Integer
        Private ReadOnly m_TabHeight As Integer

        <Description("Initializes a new instance of the MdiTabControl.TabControl.GetTabRegionEventArgs class.")>
        Public Sub New(graphics As Graphics, clipRect As Rectangle, Selected As Boolean, Hot As Boolean,
                       GraphicPath As GraphicsPath, Width As Integer, Height As Integer)
        ...
        Public ReadOnly Property GraphicPath As GraphicsPath
            Get
...
#Region " Class TabPageCollection "
    ...
    Public Class TabPageCollection
        ...
        Friend Event GetTabRegion(sender As Object, e As GetTabRegionEventArgs)

        <Description("Occurs when the Tab Background has been painted.")>
        Friend Event TabPaintBackground(sender As Object, e As TabPaintEventArgs)

        <Description("Occurs when the Tab Border has been painted.")>
        Friend Event TabPaintBorder(sender As Object, e As TabPaintEventArgs)
        ...
        <
            ...
            >
        Public Function Add(Form As Form) As TabPage
        ...
        Public Sub Remove(TabPage As TabPage)
            Try
        ...
        Default Public ReadOnly Property Item(Index As Integer) As TabPage
            Get
        ...
        Default Public ReadOnly Property Item(Form As Form) As TabPage
            Get
        ...
        Public Property IndexOf(TabPage As TabPage) As Integer
            Get
        ...
        Public ReadOnly Property IndexOf(Form As Form) As Integer
            Get
        ...
        Private Sub TabPage_Clicked(sender As Object, e As EventArgs)
            TabControl.SelectItem(sender)
        End Sub

        Private Sub TabPage_Closed(sender As Object, e As EventArgs)
            Remove(sender)
        End Sub

        Private Sub TabPage_GetTabRegion(sender As Object, e As GetTabRegionEventArgs)
            RaiseEvent GetTabRegion(sender, e)
        End Sub

        Private Sub TabPage_TabPaintBackground(sender As Object, e As TabPaintEventArgs)
            RaiseEvent TabPaintBackground(sender, e)
        End Sub

        Private Sub TabPage_TabPaintBorder(sender As Object, e As TabPaintEventArgs)
            RaiseEvent TabPaintBorder(sender, e)
        End Sub

        Private Sub TabPage_SizeChanged(sender As Object, e As EventArgs)
            TabControl.ArrangeItems()
        End Sub

        Private Sub TabPage_Draging(sender As Object, e As MouseEventArgs)
            If TabControl.AllowTabReorder AndAlso e.Button = MouseButtons.Left Then
        ...
        Private Function GetTabPage(TabPage As TabPage, x As Integer, y As Integer) As TabPage
            For i As Integer = 0 To List.Count - 1
                If DirectCast(List(i), TabPage) IsNot TabPage AndAlso DirectCast(List(i), TabPage).TabVisible Then
                    If _
                        DirectCast(List(i), TabPage).RectangleToScreen(DirectCast(List(i), TabPage).ClientRectangle).
                            Contains(TabPage.PointToScreen(New Point(x, y))) Then
...
#End Region
    ...
    Private ReadOnly LeftOffset As Integer = 3
    Private IsDelete As Boolean = False
    Private ReadOnly Background As New Panel
    ...
    Private m_TabSmoothingMode = SmoothingMode.None
    ...
    Friend ReadOnly defaultTabCloseButtonBackHighColor As Color = Color.IndianRed
    Friend ReadOnly defaultTabCloseButtonBackHighColorDisabled As Color = Color.LightGray
    Friend ReadOnly defaultTabCloseButtonBackHighColorHot As Color = Color.LightCoral
    Friend ReadOnly defaultTabCloseButtonBackLowColor As Color = Color.Firebrick
    Friend ReadOnly defaultTabCloseButtonBackLowColorDisabled As Color = Color.DarkGray
    Friend ReadOnly defaultTabCloseButtonBackLowColorHot As Color = Color.IndianRed
    Friend ReadOnly defaultTabCloseButtonBorderColor As Color = Color.DarkRed
    Friend ReadOnly defaultTabCloseButtonBorderColorDisabled As Color = Color.Gray
    Friend ReadOnly defaultTabCloseButtonBorderColorHot As Color = Color.Firebrick
    Friend ReadOnly defaultTabCloseButtonForeColor As Color = Color.White
    Friend ReadOnly defaultTabCloseButtonForeColorDisabled As Color = Color.White
    Friend ReadOnly defaultTabCloseButtonForeColorHot As Color = Color.White
    ...
    Public Event GetTabRegion(sender As Object, e As GetTabRegionEventArgs)

    <Description("Occurs when the Tab Background has been painted.")>
    Public Event TabPaintBackground(sender As Object, e As TabPaintEventArgs)

    <Description("Occurs when the Tab Border has been painted.")>
    Public Event TabPaintBorder(sender As Object, e As TabPaintEventArgs)
    ...
    <Browsable(True), Category("Layout"), DefaultValue(FlowDirection.LeftToRight),
    ...
    <Browsable(True), Category("Appearance"),
        ...
        >
    Public Property TabCloseButtonBackHighColor As Color
        Get
    ...
    <Browsable(True), Category("Appearance"),
        ...
        >
    Public Property TabCloseButtonBackLowColor As Color
        Get
    ...
    <Browsable(True), Category("Appearance"),
        ...
        >
    Public Property TabCloseButtonBorderColor As Color
        Get
    ...
    <Browsable(True), Category("Appearance"),
        ...
        >
    Public Property TabCloseButtonForeColor As Color
        Get
    ...
    <Browsable(True), Category("Appearance"),
        ...
        >
    Public Property TabCloseButtonBackHighColorDisabled As Color
        Get
    ...
    <Browsable(True), Category("Appearance"),
        ...
        >
    Public Property TabCloseButtonBackLowColorDisabled As Color
        Get
    ...
    <Browsable(True), Category("Appearance"),
        ...
        >
    Public Property TabCloseButtonBorderColorDisabled As Color
        Get
    ...
    <Browsable(True), Category("Appearance"),
        ...
        >
    Public Property TabCloseButtonForeColorDisabled As Color
        Get
    ...
    <Browsable(True), Category("Appearance"),
        ...
        >
    Public Property TabCloseButtonBackHighColorHot As Color
        Get
    ...
    <Browsable(True), Category("Appearance"),
        ...
        >
    Public Property TabCloseButtonBackLowColorHot As Color
        Get
    ...
    <Browsable(True), Category("Appearance"),
        ...
        >
    Public Property TabCloseButtonBorderColorHot As Color
        Get
    ...
    <Browsable(True), Category("Appearance"),
        ...
        >
    Public Property TabCloseButtonForeColorHot As Color
        Get
    ...
    <Browsable(True), Category("Appearance"), DefaultValue(SmoothingMode.None),
        Description _
    ...
    <Browsable(True), Category("Layout"), DefaultValue(5),
    ...
    <Browsable(True), Category("Layout"), DefaultValue(3),
    ...
    <Browsable(True), Category("Appearance"),
        ...
        >
    Public Property TabBackHighColor As Color
        Get
    ...
    <Browsable(True), Category("Appearance"),
        ...
        >
    Public Property TabBackHighColorDisabled As Color
        Get
    ...
    <Browsable(True), Category("Behavior"), DefaultValue(TabAlignment.Top),
    ...
    <Browsable(True), Category("Appearance"),
        ...
        >
    Public Property ControlButtonBackHighColor As Color
        Get
    ...
    ''' <summary>
    '''     设置控件大小位置，当控件无法显示关闭窗口和下拉选择窗口按钮的时候，请调用此方法
    ''' </summary>
    Public Sub SetControlsSizeLocation()
    ...
    Private Sub SelectItem(TabPage As TabPage)
        For Each T As TabPage In TabPages
            T.IsSelected = False
        Next
    ...
    Private Sub TabControl_FontChanged(sender As Object, e As EventArgs) Handles Me.FontChanged
        For Each t As TabPage In TabPages
            t.Font = Font
        Next
    End Sub

    Private Sub TabControl_ForeColorChanged(sender As Object, e As EventArgs) Handles Me.ForeColorChanged
        For Each t As TabPage In TabPages
            t.ForeColor = ForeColor
        Next
    End Sub

    Private Sub TabControl_Paint(sender As Object, e As PaintEventArgs) Handles Me.Paint
        If m_TopSeparator Then
            ControlPaint.DrawBorder3D(e.Graphics, New Rectangle(- 2, 0, Me.Width + 4, - 2))
        End If
    End Sub

    Private Sub TabControl_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        CheckVisibility()
    End Sub

    Private Sub pnlTop_SizeChanged(sender As Object, e As EventArgs) Handles pnlTop.SizeChanged
        PositionButtons()
    End Sub

    Private Sub PositionButtons()
        DropButton.Top = Math.Ceiling((pnlTop.Height - DropButton.Height)/2) +
                         IIf(Alignment = TabAlignment.Top And TopSeparator, - 1, 0)
    ...
    Private Sub pnlTop_Paint(sender As Object, e As PaintEventArgs) Handles pnlTop.Paint
        Dim _
            Brush As _
                New LinearGradientBrush(New Point(0, 0), New Point(0, pnlTop.Height),
                                        RenderColors.BackHighColor(m_RenderMode, BackHighColor),
                                        RenderColors.BackLowColor(m_RenderMode, BackLowColor))
    ...
    Private Sub DropButton_MouseDown(sender As Object, e As MouseEventArgs) Handles DropButton.MouseDown
        WinMenu.Items.Clear()
        For i As Integer = 0 To Items.Count - 1
    ...
    Private Sub Items_GetTabRegion(sender As Object, e As GetTabRegionEventArgs) Handles Items.GetTabRegion
        RaiseEvent GetTabRegion(sender, e)
    End Sub

    Private Sub Items_TabPaintBackground(sender As Object, e As TabPaintEventArgs) Handles Items.TabPaintBackground
        RaiseEvent TabPaintBackground(sender, e)
    End Sub

    Private Sub Items_TabPaintBorder(sender As Object, e As TabPaintEventArgs) Handles Items.TabPaintBorder
        RaiseEvent TabPaintBorder(sender, e)
    End Sub

    Public Sub SetColors(ColorTable As ProfessionalColorTable)
...
Friend Module Helper
    Friend Function CreateGlassGradientBrush(Rectangle As Rectangle, Color1 As Color, Color2 As Color) _
        As LinearGradientBrush
        Dim b As New LinearGradientBrush(Rectangle, Color1, Color2, LinearGradientMode.Vertical)
    ...
    Friend Class Colors
        Public Function BackHighColor(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
        ...
        Public Function BackLowColor(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
                Return Color.Transparent
            ElseIf RenderMode = ToolStripRenderMode.Professional Then
        ...
        Public Function BorderColor(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
        ...
        Public Function BorderColorDisabled(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
        ...
        Public Function ControlButtonBackHighColor(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
        ...
        Public Function ControlButtonBackLowColor(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
                Return SystemColors.ButtonHighlight
            ElseIf RenderMode = ToolStripRenderMode.Professional Then
        ...
        Public Function ControlButtonBorderColor(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
        ...
        Public Function TabBackHighColor(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
        ...
        Public Function TabBackLowColor(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
                Return SystemColors.Control
            ElseIf RenderMode = ToolStripRenderMode.Professional Then
        ...
        Public Function TabBackHighColorDisabled(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
                Return SystemColors.Control
            ElseIf RenderMode = ToolStripRenderMode.Professional Then
        ...
        Public Function TabBackLowColorDisabled(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
                Return SystemColors.Control
            ElseIf RenderMode = ToolStripRenderMode.Professional Then
        ...
        Public Function TabCloseButtonBackHighColor(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
                Return Color.Transparent
            ElseIf RenderMode = ToolStripRenderMode.Professional Then
                Return Color.Transparent
        ...
        Public Function TabCloseButtonBackHighColorDisabled(RenderMode As ToolStripRenderMode, ManagedColor As Color) _
            As Color
            If RenderMode = ToolStripRenderMode.System Then
                Return Color.Transparent
            ElseIf RenderMode = ToolStripRenderMode.Professional Then
        ...
        Public Function TabCloseButtonBackHighColorHot(RenderMode As ToolStripRenderMode, ManagedColor As Color) _
            As Color
            If RenderMode = ToolStripRenderMode.System Then
                Return SystemColors.ButtonHighlight
            ElseIf RenderMode = ToolStripRenderMode.Professional Then
        ...
        Public Function TabCloseButtonBackLowColor(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
                Return Color.Transparent
            ElseIf RenderMode = ToolStripRenderMode.Professional Then
                Return Color.Transparent
        ...
        Public Function TabCloseButtonBackLowColorDisabled(RenderMode As ToolStripRenderMode, ManagedColor As Color) _
            As Color
            If RenderMode = ToolStripRenderMode.System Then
                Return Color.Transparent
            ElseIf RenderMode = ToolStripRenderMode.Professional Then
        ...
        Public Function TabCloseButtonBackLowColorHot(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
                Return SystemColors.ButtonHighlight
            ElseIf RenderMode = ToolStripRenderMode.Professional Then
        ...
        Public Function TabCloseButtonBorderColor(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
                Return SystemColors.ControlDark
            ElseIf RenderMode = ToolStripRenderMode.Professional Then
                Return Color.Transparent
        ...
        Public Function TabCloseButtonBorderColorDisabled(RenderMode As ToolStripRenderMode, ManagedColor As Color) _
            As Color
            If RenderMode = ToolStripRenderMode.System Then
        ...
        Public Function TabCloseButtonBorderColorHot(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
                Return SystemColors.HotTrack
            ElseIf RenderMode = ToolStripRenderMode.Professional Then
                Return Color.Gray
        ...
        Public Function TabCloseButtonForeColor(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
        ...
        Public Function TabCloseButtonForeColorDisabled(RenderMode As ToolStripRenderMode, ManagedColor As Color) _
            As Color
            If RenderMode = ToolStripRenderMode.System Then
                Return SystemColors.GrayText
            ElseIf RenderMode = ToolStripRenderMode.Professional Then
        ...
        Public Function TabCloseButtonForeColorHot(RenderMode As ToolStripRenderMode, ManagedColor As Color) As Color
            If RenderMode = ToolStripRenderMode.System Then
                Return SystemColors.ControlText
            ElseIf RenderMode = ToolStripRenderMode.Professional Then
