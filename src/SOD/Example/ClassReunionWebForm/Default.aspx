...
<div class="container-fluid">
    <div class="jumbotron">
        <h1>同学们, 大家好!</h1>
        <p>
            今年时值<span class="label label-info"><%= SchoolName %></span>毕业<%= SchoolYear %>周年了，<%= Head_Holidays %>间有些在外地的同学可以回来，
            看能不能搞一个同学聚会庆祝下，愿意参加的同学，请网上填报下表格；不能来的
            同学，也请奔走相告，捎个信儿：）
        </p>
        <p>
            初步计划时间：<%= Head_ReunionDate %>，活动内容：<%= Head_ReunionNote %>。
            网上报名地址：<%= Head_reg_link %> ( <%= Head_reg_memo %> ，该网址手机也可以访问。)
        </p>

        <h2>“大家都是一个班级”，<%= SchoolYear %>周年同学会，期待您的参与和支持！</h2>
        <p> 2015.9月</p>
    </div>
    <div class="row-fluid">
                ...
                <div class="row-fluid">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <p>
                                填写本联系表<span class="label label-info">无需注册，无需登录</span>，所以请填写<span class="label label-primary">“身份ID”</span>，当密码使用，用于修改数据和其它功能，
                                请使用你常用不会遗忘的数字，建议使用身份证号，这样如果您需要联系住宿或者预定车票的话，方便为您服务。
                            </p>
                            <p>
                            ...
                            <% if (MemberCount > 0)
                               { %>
                                ...
                                <button class="btn btn-success" type="button">
                                    报名人数 <span class="badge"><%= MemberCount %></span>
                                </button>
                            <% }
                               else
                               { %>
