namespace SuperMarketModel
{
    ...
    public class Cashier
    {
        ...
        {
            UsingCashierRegister = cashRegister;
        }

        /// <summary>
        ///     使用的收银机
        /// </summary>
        public CashierRegisterMachines UsingCashierRegister { get; set; }
        ...
        public bool CashRegister(Customer customer)
        {
            ...
            foreach (var goods in customer.Goodss)
                //使用收银机扫商品进行收银
                UsingCashierRegister.CashRegisters(goods);

            //通知顾客一共收多少钱
            return customer.ListenAmount(UsingCashierRegister.ShowAmount());
        }
    }
}