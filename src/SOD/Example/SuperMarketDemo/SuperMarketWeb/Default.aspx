...
<%@ Import Namespace="PWMIS.DataProvider.Data" %>
...
<form id="form1" runat="server">
    <div style="background-color: #FFCC99; border-style: groove">
        ...
        <span class="style4">
            <a
                href="http://www.pwmis.com/sqlmap">
                SOD 框架
            </a>之
            <a
                href="http://pwmis.codeplex.com">
                超市管理系统 Demo实例程序
            </a>
        </span><br/>
        欢迎光临本超市，请输入你的会员号：<br/>
    ...
    <div style="line-height: normal; background-color: #FFCC66; border-style: outset">
        <table>
            ...
            <tr>
                <td class="style2">如果不想注册，也可以</td>
                <td>
                    <asp:Button ID="btnNiming" runat="server" Text="匿名进入"
            ...
            <tr>
                ...
                <td class="style5">
                    <a href="LoginMarketMIS.aspx">管理员登录</a>
                </td>
            </tr>
        </table>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr style="color:#8C4510;background-color:#FFF7E7;">
                ...
                <td >
                    <cc1:DataTextBox ID="dbtCID" runat="server" LinkObject="CustomerContactInfo"
                                     ...
                                     MessageType="层" onclickshowinfo="True" RegexName="客户号">
                    </cc1:DataTextBox>
                </td>
            </tr>
            <tr style="color:#8C4510;background-color:#FFF7E7;">
                ...
                <td >
                    <cc1:DataTextBox ID="dtbCustomerName" runat="server" LinkObject="CustomerContactInfo"
                                     ...
                                     ErrorMessage="姓名不能为空" isNull="False" OftenType="无">
                    </cc1:DataTextBox>
                </td>
            </tr>
            <tr style="color:#8C4510;background-color:#FFF7E7;">
            ...
            <tr style="color:#8C4510;background-color:#FFF7E7;">
                ...
                <td >
                    <cc1:DataTextBox ID="DataTextBox5" runat="server" LinkObject="CustomerContactInfo"
                                     ...
                                     OftenType="电话号码或手机" onclickshowinfo="True" RegexName="电话号码">
                    </cc1:DataTextBox>
                </td>
            </tr>
            <tr style="color:#8C4510;background-color:#FFF7E7;">
                ...
                <td >
                    <cc1:DataTextBox ID="DataTextBox6" runat="server" LinkObject="CustomerContactInfo"
                                     LinkProperty="Address" Width="256px" SysTypeCode="String">
                    </cc1:DataTextBox>
                </td>
            </tr>
            <tr style="color:#8C4510;background-color:#FFF7E7;">
    ...
    <hr/>
    本系统基于<a href="http://www.pwmis.com/sqlmap">PDF.NET</a> <%= Assembly.GetAssembly(typeof(AdoHelper)).GetName().Version.ToString() %> 构建，<a href="index.htm">系统说明</a>
    <br/>
