        ...
        <tr style="color:#8C4510;background-color:#FFF7E7;">
            ...
            <td >
                <cc1:DataTextBox ID="dtbSN" runat="server" LinkObject="设备表"
                                 LinkProperty="编号" PrimaryKey="True" Width="126px" SysTypeCode="String">
                </cc1:DataTextBox>
        ...
        <tr style="color:#8C4510;background-color:#FFF7E7;">
            ...
            <td >
                <cc1:DataTextBox ID="DataTextBox2" runat="server" LinkObject="设备表"
                                 LinkProperty="设备名称" Width="256px" SysTypeCode="String">
                    收银机
                </cc1:DataTextBox>
            </td>
        </tr>
        <tr style="color:#8C4510;background-color:#FFF7E7;">
            ...
            <td >
                <cc1:DataTextBox ID="DataTextBox3" runat="server" LinkObject="设备表"
                                 LinkProperty="型号" Width="256px" SysTypeCode="String">
                </cc1:DataTextBox>
            </td>
        </tr>
        <tr style="color:#8C4510;background-color:#FFF7E7;">
        ...
        <tr style="color:#8C4510;background-color:#FFF7E7;">
            ...
            <td >
                <cc1:DataTextBox ID="DataTextBox1" runat="server" LinkObject="设备表"
                                 LinkProperty="备注" Width="256px" SysTypeCode="String">
                </cc1:DataTextBox>
            </td>
        </tr>
        <tr style="color:#8C4510;background-color:#FFF7E7;">
