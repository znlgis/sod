...
<%@ Import Namespace="SuperMarketBLL" %>
    ...
    <asp:GridView ID="GridView1" runat="server" BackColor="#DEBA84"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="收银员">
                <ItemTemplate>
                    <%# ((CashierRegisterBIZ)Container.DataItem).CurrCashier.CashierName %>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="工号">
                <ItemTemplate>
                    <%# ((CashierRegisterBIZ)Container.DataItem).CurrCashier.WorkNumber %>
                </ItemTemplate>
                <ItemStyle Width="100px"/>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="收银机号">
                <ItemTemplate>
                    <%# ((CashierRegisterBIZ)Container.DataItem).CurrCRManchines.CashRegisterNo %>
                </ItemTemplate>
