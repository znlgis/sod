        ...
        <tr>
            <td>
                ...
                <ul>
                    ...
                    <li>
                        标注有折扣价的，执行折扣价，否则执行原价；
                    </li>
                    <li>
                        标注有会员价的，如果是会员，执行会员价，否则执行原价；
                    </li>
                    <li>
                        如果商品有折扣价，不论是否会员，只能享受折扣价；
                    </li>
                ...
                <table style="border-style: double; background-color :#DEBA84">
                    <tr>
                        ...
                        <td>
                            ...
                            件
                            <asp:Button ID="btnEditBuyCount" runat="server" Text="修改"
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <asp:Button ID="btnBuy" runat="server" Text="加入购物车" onclick="btnBuy_Click"/>
                        </td>
                    </tr>
                </table>
