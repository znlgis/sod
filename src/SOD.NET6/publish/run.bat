...
echo publish DaMeng
copy ..\OtherProvider\PWMIS.DataProvider.Data.Dameng\bin\Debug\*.nupkg NugetPkgs
echo publish Kingbase
copy ..\OtherProvider\PWMIS.DataProvider.Data.Kingbase\bin\Debug\*.nupkg NugetPkgs
echo publish MySQL
