...
namespace PWMIS.DataMap.Entity
{
    ...
    /// </summary>
    [Serializable]
    internal abstract class Entity : INotifyPropertyChanged, ICloneable
    {
        private string _identity = "";
        private List<string> _pks = new();

        /// <summary>
        ///     属性-值列表，键 不区分大小写
        /// </summary>
        private Dictionary<string, object> _propertyList = new(StringComparer.OrdinalIgnoreCase);
        ...
        public Entity()
        {
            PropertyChangedList = new Dictionary<string, bool>();
        }
        ...
        ///     获取属性列表
        /// </summary>
        public Dictionary<string, object> PropertyList => _propertyList;

        /// <summary>
        ///     获取值改变的属性
        /// </summary>
        public Dictionary<string, bool> PropertyChangedList { get; }
        ...
        protected void AddProperty(string name, object Value)
        {
            ...
            PropertyChangedList[name] = false;
        }
    ...
    public class PropertyChangingEventArgs : EventArgs
    {
        ...
        public PropertyChangingEventArgs(string propertyFieldName, object value, int length, DbType dbType)
        {
            PropertyName = propertyFieldName;
            NewValue = value;
